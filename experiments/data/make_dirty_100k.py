...
def make_dirty():
    np.random.seed(42)
    file_path = 'experiments/data/download/ACSIncome_2018_100K.csv'
    ...
    df.to_csv('experiments/data/dirty_ACSIncome_2018_100K.csv', index=False)
    print(f"Successfully manipulated data into experiments/data/dirty_ACSIncome_2018_100K.csv")
