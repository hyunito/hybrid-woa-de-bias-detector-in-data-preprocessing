...
def make_dirty():
    np.random.seed(42)
    file_path = 'backend/data/download/ACSIncome_2018_10K.csv'
    ...
    df.to_csv('backend/data/dirty_ACSIncome_2018_10K.csv', index=False)
    print(f"Successfully manipulated data into backend/data/dirty_ACSIncome_2018_10K.csv")
